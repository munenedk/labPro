...
public class CreateCourse extends JPanel {
	...
	private JComboBox<String> comboPrerequisites;
	private JComboBox<String> comboResource;
	private JLabel lblPrerequisiteIdentifier;
	private JLabel lblPrerequisites;
	private JButton btnSavePrerequisite;
	private JLabel lblResourceIdentifier;
	private JLabel lblResources;
	private JButton btnSaveResource;
	...
	public CreateCourse() {
		...
		rdbtnPrereqYes.addMouseListener(new MouseAdapter() {
			@SuppressWarnings({ "unchecked", "rawtypes" })
			@Override
			public void mouseClicked(MouseEvent arg0) {
				comboPrerequisites.setEnabled(true);
		...
		rdbtnPrereqNo.addMouseListener(new MouseAdapter() {
			@SuppressWarnings({ "unchecked", "rawtypes" })
			@Override
			public void mouseClicked(MouseEvent e) {
				comboPrerequisites.setEnabled(false);
				ArrayList<String[]> prerequisites = controller.loadCoursePrerequisites();
				List<String> thePrereqs = new ArrayList<String>();
				for (String[] prerequisite : prerequisites) {
		...
		comboPrerequisites = new JComboBox<String>();
		comboPrerequisites.setEnabled(false);
		...
		rdbtnPrereqListedYes.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				...
				btnSavePrerequisite.setEnabled(false);
			}
		});
		...
		rdbtnPrereqListedNo.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				lblPrerequisiteIdentifier.setEnabled(true);
				txtPrereqID.setEnabled(true);
				lblPrerequisites.setEnabled(true);
				txtPrerequisites.setEnabled(true);
				btnSavePrerequisite.setEnabled(true);
			}
		});
		...
		lblPrerequisiteIdentifier = new JLabel("Prerequisite Identifier");
		lblPrerequisiteIdentifier.setEnabled(false);
		...
		comboResource = new JComboBox<String>();
		comboResource.addMouseListener(new MouseAdapter() {
		...
		rdbtnYes.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				btnSaveResource.setEnabled(false);
			}
		});
		...
		rdbtnNo.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				lblResourceIdentifier.setEnabled(true);
				txtResourceID.setEnabled(true);
				lblResources.setEnabled(true);
				txtResources.setEnabled(true);
				btnSaveResource.setEnabled(true);
			}
		});
		...
		btnSaveDetails.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				controller.SaveCourse(txtCourseCode.getText(), txtCourseName.getText(),
						Integer.parseInt(txtExpectedCapacity.getText()), comboProgram.getSelectedItem().toString(),
						comboPrerequisites.getSelectedItem().toString(), comboResource.getSelectedItem().toString(),
						comboDegree.getSelectedItem().toString());
			}
		});
		...
		btnSavePrerequisite = new JButton("Save Prerequisite");
		btnSavePrerequisite.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				controller.SavePrerequisites(txtPrereqID.getText(), txtPrerequisites.getText());
			}
		});
		btnSavePrerequisite.setEnabled(false);
		btnSavePrerequisite.setBounds(636, 133, 132, 28);
		add(btnSavePrerequisite);
		...
		lblResourceIdentifier = new JLabel("Resource Identifier");
		lblResourceIdentifier.setEnabled(false);
		...
		btnSaveResource = new JButton("Save Resource");
		btnSaveResource.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				controller.SaveResources(txtResourceID.getText(), txtResources.getText());
			}
		});
		btnSaveResource.setEnabled(false);
